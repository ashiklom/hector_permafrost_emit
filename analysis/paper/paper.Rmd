...
In this study, we use Hector to evaluate the global sensitivty of climate to terrestrial biosphere processes, and how this uncertainty 
...
# readd(draws_global_sims)
knitr::include_graphics(file_in(here::here("analysis", "figures", "global_draws.png")))
```
...
knitr::include_graphics(file_in(here::here("analysis", "figures", "biome_draws.png")))
```
